...
Lo que antes era hardcode (nombre del agente, tono, saludo, estilo de venta,
reglas extra, modelos, temperatura, comportamiento) vive aquí como JSON por
tenant en disco. Los valores vacíos/None caen al perfil de `negocio.md` y a
las variables de entorno, así que sin configurar nada el agente sigue igual.
"""
...
@dataclass
class AgentSettings:
    # Identidad (vacío = tomar de negocio.md)
    agent_name: str = ""
    business_name: str = ""
    tone: str = ""
    greeting: str = ""
    ...
    # Modelos (vacío = env MODEL_ID / CLASSIFIER_MODEL_ID)
    text_model: str = ""
    ...
    def effective_classifier(self, default: str) -> str:
        return self.classifier_model.strip() or default
